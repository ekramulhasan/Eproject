                       ...
                       <div class="col-12">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-floating">
                                ...
                                is-invalid
                                @enderror" placeholder="Short Description" id="short_description" style="height: 150px" name="short_description"></textarea>
                          ...
                          <div class="mb-3">
                            ...
                            <div class="form-floating">
                                ...
                                is-invalid
                                @enderror" placeholder="Long Description" id="short_description" style="height: 150px" name="long_description"></textarea>
                          ...
                          <div class="mb-3">
                            ...
                            <div class="form-floating">
                                ...
                                <textarea class="form-control @error('long_description')
                                is-invalid
                                @enderror" placeholder="Additional info" id="short_description" style="height: 150px" name="additional_info"></textarea>
