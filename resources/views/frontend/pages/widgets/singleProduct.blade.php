...
@include('backend.layouts.inc.breadCumb',['pageName' =>$product->title])
            ...
            <div class="col-lg-6">
                <div class="product-single-img">
                    <div class="product-active owl-carousel">
                        <div class="item">
                            <img src="{{ asset('assets/uploads/products') }}/{{ $product->product_img }}" alt="">
                        </div>

                        @foreach ($product->productImage as $moreImage)

                        <div class="item">
                            <img src="{{ asset('assets/uploads/products') }}/{{ $moreImage->product_multiple_img_name }}" alt="">
                        </div>
            ...
            <div class="col-lg-6">
                <div class="product-single-content">
                    ...
                    <ul class="input-style">
                        ...
                        <form action="{{ route('addTo.cart',['product_slug'=>$product->slug]) }}" method="post">
                            @csrf

                         <input type="hidden" name="product_slug" value="{{ $product->slug }}">

                        <li class="quantity cart-plus-minus">
                            <input type="text" value="1" name="product_qnty"/>
                        </li>

                        {{-- <li><a href="" type="submit" >Add to Cart</a></li> --}}
                        {{-- <li><input type="submit" value="Add to Cart"></li> --}}
                        {{-- <li><a href="" onclick="link">Add to Cart</a></li> --}}
                        <li><button type="submit" class="btn-danger p-1">Add to Cart</button></li>
